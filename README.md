...
7. A new windows will open, the `Configure Hardware Profile`:
  ...
  - chose a resolution (the lower the resolution the better performance the emulator will have), we recommend `320x640`
