...
# Exercise
The goal of this exercise is to run an app inside the Android Studio emulator on **Windows OS** and then collect the files generated by that app. Appart from the installation process, the steps for Linux are similar.

> **_NOTES_**
> 
> - The emulator installed with Android Studio requires the Intel [Hardware Accelerated Execution Manager (HAXM)](https://github.com/intel/haxm) drivers;
> - However, HAXM is **not** compatible with the "Windows Hypervisor Platform";
